...
输出：4
 ...
 Related Topics 深度优先搜索 广度优先搜索 数组 矩阵 👍 546 👎 0
...
public class L_463_IslandPerimeter {
    public static void main(String[] args) {
        Solution solution = new L_463_IslandPerimeter().new Solution();
    }
...
class Solution {
    ...
    public int dp(int[][] grid, int i, int j) {
        ...
        int t2 = dp(grid, i + 1, j);
        int t3 = dp(grid, i, j - 1);
        int t4 = dp(grid, i, j + 1);
        return t1 + t2 + t3 + t4;
    }
}
