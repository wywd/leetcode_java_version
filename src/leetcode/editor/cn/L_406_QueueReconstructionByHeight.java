...
输出：[[4,0],[5,0],[2,2],[3,2],[1,4],[6,0]]
 ...
 Related Topics 贪心 数组 排序 👍 1110 👎 0
...
public class L_406_QueueReconstructionByHeight {
    public static void main(String[] args) {
        Solution solution = new L_406_QueueReconstructionByHeight().new Solution();
        int[][] people = new int[][]{
                new int[]{7,0},
                new int[]{4,4},
                new int[]{7,1},
...
class Solution {  // 贪心的思想，因为有两个维度，分两次贪心
    public int[][] reconstructQueue(int[][] people) {
        Arrays.sort(people, (x, y) -> x[0] != y[0] ? y[0] - x[0] : x[1] - y[1]);  // 先按照身高排序
