...
public class L_232_ImplementQueueUsingStacks {
    public static void main(String[] args) {
        MyQueue solution = new L_232_ImplementQueueUsingStacks().new MyQueue();
    }
...
class MyQueue {
    ...
    public void push(int x) {
        firstStack.offerLast(x);
    }

    public int pop() {
        if (secondStack.isEmpty()) {
            while (!firstStack.isEmpty()) {
                secondStack.offerLast(firstStack.pollLast());
            }
        }
